...
public class ClockV7 extends AdvancedBitmapDrawer {
	...
	private void drawAll(final int level) {
		...
		new RingPart(center, maxRadius * 0.99f, maxRadius * 0.94f, new Paint())//
				...
				.setOutline(new Outline(PaintProvider.getGray(128), strokeWidth * 0.5f))//
				.draw(bitmapCanvas);
		new RingPart(center, maxRadius * 0.94f, maxRadius * 0.65f, new Paint())//
				.setGradient(new Gradient(PaintProvider.getGray(32), PaintProvider.getGray(96), GRAD_STYLE.top2bottom))//
				.setOutline(new Outline(PaintProvider.getGray(128), strokeWidth * 0.50f))//
				.draw(bitmapCanvas);

		// level ring
		new LevelPart(center, maxRadius * 0.90f, maxRadius * 0.76f, level, -90, 360, EZColoring.LevelColors)//
		...
		// Gegenläufiger Level
		new LevelPart(center, maxRadius * 0.74f, maxRadius * 0.70f, 100 - level, -90, -360, EZColoring.ColorOf100)//
				.setSegemteAbstand(1f)//
				.setStrokeWidth(strokeWidth / 3)//
				.setMode(EZMode.Einer)//
		...
		Skala.getLevelScalaCircular(center, maxRadius * 0.94f, maxRadius * 0.90f, -90, LevelLinesStyle.ZehnerFuenferEiner)//
				.setDicke(strokeWidth)//
				.setFontAttributesEbene1(new FontAttributes(fontSizeScala))//
				.setFontRadiusEbene1(maxRadius * 0.79f)//
		...
		if (Settings.isShowExtraLevelBars()) {
			...
			final float ri = maxRadius * 0.44f;
			new LevelPart(center, maxRadius * 0.54f, ri, level, -225, maxScala, EZColoring.ColorOf100)//
			...
			new LevelPart(center, maxRadius * 0.54f, ri, level, 45, -maxScala, EZColoring.ColorOf100)//
					.setSegemteAbstand(1.5f)//
					.setStrokeWidth(strokeWidth / 3)//
