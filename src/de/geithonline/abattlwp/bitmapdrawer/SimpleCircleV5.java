...
public class SimpleCircleV5 extends AdvancedBitmapDrawer {
	...
	private void drawAll(final int level) {
		...
		// Skala
		Skala.getLevelScalaCircular(center, maxRadius * 0.75f, maxRadius * 0.85f, -90, LevelLinesStyle.ZehnerFuenferEiner)//
		...
		// Level
		new LevelPart(center, maxRadius * 0.78f, maxRadius * 0.72f, level, -90, 360, EZColoring.LevelColors)//
		...
		new LevelPart(center, maxRadius * 0.72f, maxRadius * 0.7f, level, -90, 360, EZColoring.LevelColors)//
				.setSegemteAbstand(1.25f)//
				.setStrokeWidth(strokeWidth / 3)//
				.setStyle(Settings.getLevelStyle())//
				.setMode(Settings.getLevelMode())//
		...
		if (Settings.isShowZeiger()) {
			// Zeiger
			new LevelZeigerPart(center, level, maxRadius * 0.8f, maxRadius * 0.70f, strokeWidth, -90, 360, EZMode.Einer)//
	...
	public void drawChargeStatusText(final int level) {
		...
		new TextOnCirclePart(center, maxRadius * 0.60f, winkel, fontSizeArc, new Paint())//
