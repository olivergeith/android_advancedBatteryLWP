...
public class ZoopaV1 extends AdvancedBitmapDrawer {
	...
	private void drawAll(final int level) {
		...
		new RingPart(center, maxRadius * 0.99f, maxRadius * 0.80f, new Paint())//
				.setColor(PaintProvider.getGray(32))//
		...
		// Level
		new LevelPart(center, maxRadius * 0.79f, maxRadius * 0.70f, level, -90, 360, EZColoring.Colorfull)//
				.setSegemteAbstand(1f)//
				.setStrokeWidth(strokeWidth / 3)//
				.setStyle(Settings.getLevelStyle())//
				.setMode(Settings.getLevelMode())//
				.draw(bitmapCanvas);
		new LevelPart(center, maxRadius * 0.69f, maxRadius * 0.65f, level, -90, 360, EZColoring.LevelColors)//
				.setSegemteAbstand(1f)//
				.setStrokeWidth(strokeWidth / 3)//
				.setStyle(Settings.getLevelStyle())//
				.setMode(Settings.getLevelMode())//
	...
	private void drawMeter() {
		if (Settings.isShowVoltmeter()) {
			final SkalaPart s = Skala.getDefaultVoltmeterPart(center, maxRadius * 0.36f, maxRadius * 0.41f, -135, 90, VoltLinesStyle.style_500_100_50)//
		...
		if (Settings.isShowThermometer()) {
			final SkalaPart s = Skala.getDefaultThermometerPart(center, maxRadius * 0.36f, maxRadius * 0.41f, 135, -90, LevelLinesStyle.ZehnerFuenfer)//
					.setFontAttributesEbene1(new FontAttributes(Align.CENTER, Typeface.DEFAULT, fontSizeScala * 0.85f))//
					.setFontRadiusEbene1(maxRadius * 0.51f)//
					.invertText(true)//
					.setupDefaultBaseLineRadius()//
					.setDicke(strokeWidth * 0.5f)//
					.draw(bitmapCanvas);
