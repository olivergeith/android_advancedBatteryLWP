...
public class SimpleCircleV1 extends AdvancedBitmapDrawer {
	...
	public SimpleCircleV1(final float bgRa, final float bgRi, final float levelRa, final float levelRi) {
		this.bgRa = bgRa;
		this.bgRi = bgRi;
