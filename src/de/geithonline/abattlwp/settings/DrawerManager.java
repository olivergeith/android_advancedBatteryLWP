...
import de.geithonline.abattlwp.bitmapdrawer.BrickV1;
import de.geithonline.abattlwp.bitmapdrawer.BrickV2;
import de.geithonline.abattlwp.bitmapdrawer.BrickV3;
...
import de.geithonline.abattlwp.bitmapdrawer.SimpleCircleV6;
...
public class DrawerManager {
	...
	static {
		...
		drawer.put("SimpleCircle V6", new SimpleCircleV6());
		drawer.put("Outline V1", new OutlineV1());
		drawer.put("Outline V2", new OutlineV2());
		drawer.put("Bricks V1", new BrickV1());
		drawer.put("Bricks V2", new BrickV2());
		drawer.put("Bricks V3", new BrickV3());
