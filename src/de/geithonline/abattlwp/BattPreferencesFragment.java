...
public class BattPreferencesFragment extends MyAbstractPreferenceFragment {
	...
	private void handleStyleVariante(final String style, final String newVariante) {
		...
		if (drawer.supportsVariants()) {
			// Erstmal die Variantenbox f�llen
			...
			// �bergbebene Variante null?
			if (newVariante == null) {
				// dann schauen wir, ob wir f�r diesen Drawer schon eine Variante gespeichert haben
				...
				// eine neue Variante wurde selektiert...die speichern wir unter dem Key f�r den Drawer
